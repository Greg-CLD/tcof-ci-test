...
import { 
  ...
  Compass, MapPin, Lightbulb, Lock, Briefcase
} from "lucide-react";
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
              ...
              <div className="flex flex-wrap gap-4 mt-6">
                <Link href="/organisations">
                  <Button variant="outline" className="border-tcof-teal text-tcof-teal">
                    <Briefcase className="mr-2 h-4 w-4" /> View Organisations
                  </Button>
                </Link>
              </div>
            </div>
      ...
      <Dialog open={createDialogOpen} onOpenChange={setCreateDialogOpen}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Enter basic information to get started. You can add more details later.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Textarea
                ...
                className="col-span-3"
                placeholder="Brief summary of the project aims..."
              />
            </div>
          </div>
