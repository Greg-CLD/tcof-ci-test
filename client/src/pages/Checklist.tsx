...
// Dialog components removed - not needed for task creation
import {
  Select,
  SelectContent,
  SelectItem,
...
// Import origin constants for the inline tester component
...
// Task Persistence Tester Component (inline to avoid import issues)
interface InlineTaskPersistenceTesterProps {
  projectId: string;
}

function InlineTaskPersistenceTester({ projectId }: InlineTaskPersistenceTesterProps) {
  ...
  const createTask = async (stage: string): Promise<any | null> => {
    try {
